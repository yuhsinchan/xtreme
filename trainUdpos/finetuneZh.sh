...
mkdir -p $OUTPUT_DIR/align.awesome.finetuned
for lang in zh; do
  mkdir $OUTPUT_DIR/align.awesome.finetuned/$lang
  python $REPO/third_party/run_tag.py \
    --data_dir $DATA_DIR \
    --model_type $MODEL_TYPE \
    --labels $DATA_DIR/labels.txt \
    --model_name_or_path $MODEL \
    --output_dir $OUTPUT_DIR/align.awesome.finetuned/$lang \
    ...
    --overwrite_cache \
    --aligned_suffix $lang.awesome.finetuned \
